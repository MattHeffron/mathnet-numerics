...
{
    /// <summary>
    /// This is a collection of Extension methods to allow for indexing by <c>Vector1&lt;int&gt;</c>
    /// </summary>
    /// <remarks>These could be moved into the <c>Matrix1&lt;T&gt;</c> and <c>Vector&lt;T&gt;</c> classes 
    ...
    public static class IndexingExtensionMethods
    {
        ...
        /// </summary>
        /// <param name="m">The <c>Matrix1&lt;T&gt;</c> from which to take the values for the constructed result</param>
        ...
        public static Matrix1<T> At<T>(this Matrix1<T> m, Vector1<int> indexRows, Vector1<int> indexColumns) where T : struct, IEquatable<T>, IFormattable
        {
            var source = m.Storage;
            int rows = indexRows.Count;
            int cols = indexColumns.Count;
            var result = Matrix1<T>.Build.SameAs(m, rows, cols);
        ...
        /// </summary>
        /// <param name="m">The <c>Matrix1&lt;T&gt;</c> to be updated with the values in <paramref name="newValues"/></param>
        ...
        public static void At<T>(this Matrix1<T> m, Vector1<int> indexRows, Vector1<int> indexColumns, Matrix1<T> newValues) where T : struct, IEquatable<T>, IFormattable
        {
        ...
        /// <param name="indexColumns">The indexes of the columns within <paramref name="m"/> to use in construction of the result</param>
        /// <returns>A newly constructed <c>Matrix1&lt;T&gt;</c> 
        /// This will have dimensions <c>1</c> x <c><paramref name="indexColumns"/>.Count</c>.</returns>
        public static Matrix1<T> At<T>(this Matrix1<T> m, int row, Vector1<int> indexColumns) where T : struct, IEquatable<T>, IFormattable
        {
            int cols = indexColumns.Count;
            var source = m.Storage;
            var result = Matrix1<T>.Build.SameAs(m, 1, cols);
            var dest = result.Storage;
            for (int c = 0; c < cols; c++)
            {
        ...
        public static void At<T>(this Matrix1<T> m, int row, Vector1<int> indexColumns, Vector1<T> newValues) where T : struct, IEquatable<T>, IFormattable
        {
            int cols = indexColumns.Count;
            var source = newValues.Storage;
            var dest = m.Storage;
        ...
        /// <param name="row">The index of the row within <paramref name="m"/> to use in construction of the result</param>
        /// <param name="indexColumns">The indexes of the columns within <paramref name="m"/> to use in construction of the result</param>
        /// <returns>A newly constructed <c>Vector1&lt;T&gt;</c> 
        /// This will have length <c><paramref name="indexColumns"/>.Count</c>.</returns>
        public static Vector1<T> AtV<T>(this Matrix1<T> m, int row, Vector1<int> indexColumns) where T : struct, IEquatable<T>, IFormattable
        {
            int cols = indexColumns.Count;
            var source = m.Storage;
            var result = Vector1<T>.Build.SameAs(m, cols);
            var dest = result.Storage;
            for (int c = 0; c < cols; c++)
            {
        ...
        public static Matrix1<T> At<T>(this Matrix1<T> m, Vector1<int> indexRows, int column) where T : struct, IEquatable<T>, IFormattable
        {
            int rows = indexRows.Count;
            var source = m.Storage;
            var result = Matrix1<T>.Build.SameAs(m, rows, 1);
            var dest = result.Storage;
            for (int r = 0; r < rows; r++)
            {
        ...
        public static void At<T>(this Matrix1<T> m, Vector1<int> indexRows, int column, Vector1<T> newValues) where T : struct, IEquatable<T>, IFormattable
        {
            int rows = indexRows.Count;
            var source = newValues.Storage;
            var dest = m.Storage;
        ...
        public static Vector1<T> AtV<T>(this Matrix1<T> m, Vector1<int> indexRows, int column) where T : struct, IEquatable<T>, IFormattable
        {
            int rows = indexRows.Count;
            var source = m.Storage;
            var result = Vector1<T>.Build.SameAs(m, rows);
            var dest = result.Storage;
            for (int r = 0; r < rows; r++)
            {
        ...
        /// </summary>
        /// <param name="v">The <c>Vector1&lt;T&gt;</c> from which to take the values for the constructed result</param>
        ...
        public static Vector1<T> At<T>(this Vector1<T> v, Vector1<int> indexes) where T : struct, IEquatable<T>, IFormattable
        {
            int num = indexes.Count;
            var source = v.Storage;
            var result = Vector1<T>.Build.SameAs(v, num);
            var dest = result.Storage;
            for (int n = 0; n < num; n++)
            {
        ...
        /// </summary>
        /// <param name="v">The <c>Vector1&lt;T&gt;</c> to be updated with the values in <paramref name="newValues"/></param>
        ...
        public static void At<T>(this Vector1<T> v, Vector1<int> indexes, Vector1<T> newValues) where T : struct, IEquatable<T>, IFormattable
        {
            int num = indexes.Count;
            var source = newValues.Storage;
            var dest = v.Storage;
        ...
        public static Matrix1<T> SubMatrix<T>(this Matrix1<T> m, Vector1<int> indexRows, Vector1<int> indexColumns) where T : struct, IEquatable<T>, IFormattable
        {
            if (m == null)
            {
        ...
        /// <remarks>This depends on range checking being performed at the MatrixStorage level.</remarks>
        public static void SetSubMatrix<T>(this Matrix1<T> m, Vector1<int> indexRows, Vector1<int> indexColumns, Matrix1<T> newValues) where T : struct, IEquatable<T>, IFormattable
        {
            if (m == null)
            {
                throw new ArgumentNullException("m");
        ...
        /// This will have length <c><paramref name="indexColumns"/>.Count</c>.</returns>
        /// <remarks>This depends on range checking being performed at the MatrixStorage level.</remarks>
        public static Vector1<T> SubRow<T>(this Matrix1<T> m, int row, Vector1<int> indexColumns) where T : struct, IEquatable<T>, IFormattable
        {
            if (m == null)
            {
                throw new ArgumentNullException("m");
        ...
        /// This will have dimensions <c>1</c> x <c><paramref name="indexColumns"/>.Count</c>.</returns>
        /// <remarks>This depends on range checking being performed at the MatrixStorage level.</remarks>
        public static Matrix1<T> SubMatrix<T>(this Matrix1<T> m, int row, Vector1<int> indexColumns) where T : struct, IEquatable<T>, IFormattable
        {
        ...
        /// <remarks>This depends on range checking being performed at the MatrixStorage level.</remarks>
        public static void SetSubRow<T>(this Matrix1<T> m, int row, Vector1<int> indexColumns, Vector1<T> newValues) where T : struct, IEquatable<T>, IFormattable
        {
            if (m == null)
            {
                throw new ArgumentNullException("m");
        ...
        /// This will have length <c><paramref name="indexRows"/>.Count</c>.</returns>
        /// <remarks>This depends on range checking being performed at the MatrixStorage level.</remarks>
        public static Vector1<T> SubColumn<T>(this Matrix1<T> m, Vector1<int> indexRows, int column) where T : struct, IEquatable<T>, IFormattable
        {
            if (m == null)
            {
                throw new ArgumentNullException("m");
        ...
        /// This will have dimensions <c><paramref name="indexRows"/>.Count</c> x <c>1</c>.</returns>
        /// <remarks>This depends on range checking being performed at the MatrixStorage level.</remarks>
        public static Matrix1<T> SubMatrix<T>(this Matrix1<T> m, Vector1<int> indexRows, int column) where T : struct, IEquatable<T>, IFormattable
        {
        ...
        /// <remarks>This depends on range checking being performed at the MatrixStorage level.</remarks>
        public static void SetSubColumn<T>(this Matrix1<T> m, Vector1<int> indexRows, int column, Vector1<T> newValues) where T : struct, IEquatable<T>, IFormattable
        {
            if (m == null)
            {
                throw new ArgumentNullException("m");
        ...
        /// This will have length <c><paramref name="indexes"/>.Count</c>.</returns>
        /// <remarks>This depends on range checking being performed at the MatrixStorage level.</remarks>
        public static Vector1<T> SubVector<T>(this Vector1<T> v, Vector1<int> indexes) where T : struct, IEquatable<T>, IFormattable
        {
            if (v == null)
            {
        ...
        /// <summary>
        /// Checks if an integer value is a valid row index into a <c>Matrix1&lt;T&gt;</c>
        /// <example>
        ...
        public static bool IsValidRowIndex<T>(this int index, Matrix1<T> m) where T : struct, IEquatable<T>, IFormattable
        {
            return m != null && index > 0 && index <= m.RowCount;
        }

        /// <summary>
        /// Checks if an integer value is a valid column index into a <c>Matrix1&lt;T&gt;</c>
        /// <example>
        /// Allows for "fluent" coding:
        /// <code>
        ///   Matrix1&lt;T&gt; mat = ...;
        ...
        public static bool IsValidColumnIndex<T>(this int index, Matrix1<T> m) where T : struct, IEquatable<T>, IFormattable
        {
            return m != null && index > 0 && index <= m.ColumnCount;
        }

        /// <summary>
        /// Checks if an integer value is a valid index into a <c>Vector1&lt;T&gt;</c>
        /// <example>
        /// Allows for "fluent" coding:
        /// <code>
        ///   Vector1&lt;T&gt; vec = ...;
        ...
        public static bool IsValidIndex<T>(this int index, Vector1<T> v) where T : struct, IEquatable<T>, IFormattable
        {
